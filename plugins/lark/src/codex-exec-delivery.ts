...
export function buildCodexExecPrompt(
  ...
  return [
    ...
    'For periodic review findings, prefer create_issue_proposal first; only use create_issue_from_proposal after the maintainer explicitly approves filing that proposal. Never imply merge or release will happen automatically.',
