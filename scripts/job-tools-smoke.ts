...
try {
  ...
  if (handlers.has('create_default_review_jobs')) {
    fail('create_default_review_jobs should not be registered; provider-specific review presets are not part of the core plugin');
  }
