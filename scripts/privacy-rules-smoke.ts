...
// L2.6 — rejects empty / malformed rules before persisting
...
console.log(`privacy-rules smoke: L1 ${l1Passed}/${l1Cases.length}, L2 ${l2Passed}/6, extract ${extractPassed}/6 — PASS`);
