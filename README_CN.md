...
外部 tracker 可以配置 `external_issue_create` 这类本地 wrapper，或通过独立的 provider-specific skill/MCP server 暴露。核心插件不解析 GitHub/GitLab/Jira/Linear 语义，也不提供内置 issue 或 PR 创建工具。
